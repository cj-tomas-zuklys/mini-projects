...
import net.codinginaction.mp.soapwsbu.filters.ProcessingTimeFilter;
import net.codinginaction.mp.soapwsbu.filters.RequestLoggingFilter;
import net.codinginaction.mp.soapwsbu.filters.RequestTrackingFilter;
...
public class WebAppInitializer implements WebApplicationInitializer {
	...
	private void registerServlets(ServletContext servletContext) {
		ServletRegistration.Dynamic dispatcher = servletContext.addServlet("soapws-bottomup-servlet", new CXFServlet());
